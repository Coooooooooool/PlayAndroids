...
import com.alex.playandroid.widget.login1.AnimatedViewPager;
import com.alex.playandroid.widget.login1.AuthAdapter;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initView();
//        com.alex.playandroid.widget.login2.AnimatedViewPager pager= ButterKnife.findById(this,R.id.pager);
//        pager.setAdapter(new com.alex.playandroid.widget.login2.AuthAdapter(getSupportFragmentManager(),pager));

    }

    private void initView() {
        final AnimatedViewPager pager = (AnimatedViewPager) findViewById(R.id.pager);
        final ImageView background = (ImageView) findViewById(R.id.scrolling_background);
